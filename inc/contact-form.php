...
*/
        ...
        $mailingList = htmlspecialchars($_POST['mailingList']);
  ...
  */        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
              ...
              $msgClass = 'alert-danger';   
                ...
                #Sending the email
                  ...
                  $body = 
                          '<h2>Contact Us</h2>
                          <p>This information was sent from the Contact Us Form on the IPMA-HROK Wesbite.</p>
                          <table style="border: 1px solid black;">
                            ...
                            <tr style="border: 1px solid black;">
                              <td style="font-weight:bold; border: 1px solid black;">Would like to join mailing list?</td>
                              <td style="border: 1px solid black;">'.$mailingList.'</td>
                            </tr>
                            <tr style="border: 1px solid black;">
